...
public class ItextPdfUtil {
    ...
    public void sign(String src, String target, SignatureInfo signatureInfo) {
        ...
        try {
            ...
            appearance.setVisibleSignature(new Rectangle(signatureInfo.getRectllx(), signatureInfo.getRectlly(), signatureInfo.getRecturx(), signatureInfo.getRectury()), 1, "sig1");
